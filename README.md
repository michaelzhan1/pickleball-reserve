...
In a .env file, set `AUTH_PASSWORD` to the site entry password, `FRONTEND_URL` to the frontend host, `DATABASE_URL` to the URL of the postgres database, and `AES_KEY` to the base64-encoded 32-byte key for encrypting credentials.
